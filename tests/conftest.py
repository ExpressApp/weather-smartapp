...
from botx import Bot, ChatCreatedEvent, ExpressServer
...
def bot(app: FastAPI, builder: MessageBuilder, secret_key: str) -> Bot:
    ...
    bot_app.known_hosts = [ExpressServer(host=builder.user.host, secret_key=secret_key)]
    return bot_app
